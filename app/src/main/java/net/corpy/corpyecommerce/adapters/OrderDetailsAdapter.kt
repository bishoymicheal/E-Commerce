...
class OrderDetailsAdapter(var products: List<OrdersItem>) : RecyclerView.Adapter<OrderDetailsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.cardPrice.text = product.item_price.toString() + " " + holder.itemView.context.getString(R.string.price_label)
        holder.cardWeight.text = product.weight
        holder.remove_item.visibility = View.GONE
